...
public class TeamNotificationHelper {
    ...
    public static String getMsgShowText(final IMMessage message) {
        ...
        if (message.getAttachment() instanceof MyTiptAttachment){
            messageTip="消息提示";
        }else if (message.getAttachment() instanceof ChatGiftAttachment){
            messageTip="礼物";
        }else if(message.getAttachment() instanceof RedEnvelopeAttachment){
            messageTip="红包";
        }else {
            messageTip = message.getMsgType().getSendMessageTip();
        }
