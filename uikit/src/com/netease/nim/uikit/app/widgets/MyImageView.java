...
public class MyImageView extends ImageView {
    ...
    public void setImageGestureListener( ImageGestureListener listener ){
        ...
        public boolean canScrollHorizontally(int direction) {
            if (mPinchMode == MyImageView.PINCH_MODE_SCALE) {
                return true;
            }
        ...
        public interface OuterMatrixChangedListener {
             ...
             */
            void onOuterMatrixChanged(MyImageView pinchImageView);
        }
        ...
        private GestureDetector mGestureDetector = new GestureDetector(MyImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (mOnLongClickListener != null) {
                    mOnLongClickListener.onLongClick(MyImageView.this);
                }
            }
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if (mOnClickListener != null) {
                    mOnClickListener.onClick(MyImageView.this);
                }
                return true;
            }
        });
