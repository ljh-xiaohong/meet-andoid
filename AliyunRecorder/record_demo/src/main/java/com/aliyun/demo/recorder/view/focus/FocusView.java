package com.aliyun.demo.recorder.view.focus;
...
public class FocusView extends View {
    ...
    private void initSize(Context context) {
        mSideLength = (int)context.getResources().getDimension(R.dimen.alivc_focus_rect);
    ...
    private void startScaleAnim() {
        mScaleAnimX = ObjectAnimator.ofFloat(this, "scaleX", 1.2f, 1.0f).setDuration(ANIM_DURATION);
        mScaleAnimY = ObjectAnimator.ofFloat(this, "scaleY", 1.2f, 1.0f).setDuration(ANIM_DURATION);
    ...
    public void setLocation(float x, float y) {
        setX(x - mHalfSideLength);
        setY(y - mHalfSideLength);
    }
