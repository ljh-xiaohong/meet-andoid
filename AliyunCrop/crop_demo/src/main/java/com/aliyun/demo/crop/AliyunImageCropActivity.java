...
//        new ImageLoaderImpl().loadImage(this, "file://" + path).into(mImageView);
        Glide.with(this).load("file://" + path).into(mImageView);
...
//        }
    ...
    private void startCrop() {
        ...
        int cropWidth;
        int cropHeight;
        outputPath = OUTPUT_PATH_DIR + DateTimeUtils.getDateTimeFromMillisecond(System.currentTimeMillis()) + "-crop" + mSuffix;
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                case AliyunErrorCode.ERROR_MEDIA_NOT_SUPPORTED_VIDEO:
                    ToastUtil.showToast(AliyunImageCropActivity.this, R.string.alivc_crop_error);
                    break;
                case AliyunErrorCode.ERROR_MEDIA_NOT_SUPPORTED_AUDIO:
                    ToastUtil.showToast(AliyunImageCropActivity.this, R.string.alivc_not_supported_audio);
                    break;
                default:
                    break;
                }
