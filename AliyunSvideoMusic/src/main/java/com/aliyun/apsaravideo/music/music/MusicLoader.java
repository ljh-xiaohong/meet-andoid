...
public class MusicLoader {
    ...
    private void loadOnlineMusic(int pageNo, final int pageSize, final String keyWord) {
        isLoadingMusic = true;
        mService.loadingMusicData(pageNo, pageSize, keyWord, new HttpCallback<List<MusicFileBean>>() {
            @Override
    ...
    public void downloadMusic(final MusicFileBean musicFileBean, final FileDownloaderCallback callback) {
        ...
        mService.getMusicDownloadUrlById(musicFileBean.musicId, new HttpCallback<String>() {
            @Override
