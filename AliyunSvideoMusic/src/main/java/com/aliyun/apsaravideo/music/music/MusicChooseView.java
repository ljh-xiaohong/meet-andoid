...
public class MusicChooseView extends LinearLayout implements View.OnClickListener {
    ...
    private SpannableString getClickalbeSpan() {
        ...
        spannableString.setSpan(new ForegroundColorSpan(getContext().getResources().getColor(R.color.alivc_svideo_tab_indicator_color)), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
