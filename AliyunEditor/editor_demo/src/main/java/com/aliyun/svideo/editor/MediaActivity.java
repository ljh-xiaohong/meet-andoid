...
public class MediaActivity extends Activity implements View.OnClickListener {
    ...
    private void getData() {
        mEffectInfo = (EffectInfo) getIntent().getSerializableExtra("effect_info");
    ...
    private void init() {
        ...
        mTransCoder.setTransCallback(new Transcoder.TransCallback() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        case AliyunErrorCode.ERROR_MEDIA_NOT_SUPPORTED_AUDIO:
                            ToastUtil.showToast(MediaActivity.this, R.string.alivc_not_supported_audio);
                            break;
                        case AliyunErrorCode.ERROR_MEDIA_NOT_SUPPORTED_VIDEO:
                            ToastUtil.showToast(MediaActivity.this, R.string.alivc_crop_error);
                            break;
            ...
            public void onComplete(List<MediaInfo> resultVideos) {
                ...
                //跳转EditorActivity
//                AlivcEditorRoute.startEditorActivity(MediaActivity.this, mSvideoParam, mEffectInfo, (ArrayList<com.aliyun.svideo.base.MediaInfo>) resultVideos);
                Intent intent = new Intent();
                intent.setClassName(MediaActivity.this, "com.aliyun.svideo.editor.editor.EditorActivity");
                mSvideoParam.setMediaInfo(resultVideos.get(0));
                AliyunVideoParam mVideoParam = mSvideoParam.generateVideoParam();
                intent.putExtra("video_param", mVideoParam);
                intent.putExtra("effect_info", mEffectInfo);
                intent.putParcelableArrayListExtra("key_media_info", (ArrayList<com.aliyun.svideo.base.MediaInfo>) resultVideos);
                intent.putExtra("hasTailAnimation", mSvideoParam.isHasTailAnimation());
                intent.putExtra(AlivcSvideoEditParam.INTENT_PARAM_KEY_ENTRANCE, mSvideoParam.getEntrance());
                ...
                if (info.mimeType.startsWith("image")) {
                    if (info.filePath.endsWith("gif") || info.filePath.endsWith("GIF")) {
                        ...
                        try {
                            ...
                            ToastUtils.show(MediaActivity.this, R.string.play_video_error);
                            return;
                        }
        ...
        mSelectedVideoAdapter.setItemViewCallback(new SelectedMediaAdapter.OnItemViewCallback() {
            ...
            public void onItemPhotoClick(MediaInfo info, int position) {
                ...
                if (info.filePath.endsWith("gif") || info.filePath.endsWith("GIF")) {
                    Toast.makeText(MediaActivity.this, R.string.alivc_crop_gif_not_support, Toast.LENGTH_SHORT).show();
                    return;
                }
