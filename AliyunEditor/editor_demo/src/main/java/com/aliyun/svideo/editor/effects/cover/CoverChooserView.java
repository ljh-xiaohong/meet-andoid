...
public class CoverChooserView extends BaseChooser implements View.OnClickListener {
    ...
    @Override
    protected void init() {
        mView = LayoutInflater.from(getContext()).inflate(R.layout.alivc_svideo_layout_cover, null);
        addView(mView);
        ...
        mTvEffectTitle.setText(R.string.alivc_svideo_cover);
    ...
    protected void onAttachedToWindow() {
        ...
        if (isFirstShow) {
            ...
            textView.setText(R.string.alivc_svideo_cover_tip);
