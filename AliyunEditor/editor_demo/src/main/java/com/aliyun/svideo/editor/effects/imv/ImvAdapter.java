...
//                    }
//                });
            Glide.with(mContext).load(R.mipmap.aliyun_svideo_none).into(new SimpleTarget<GlideDrawable>() {
                @Override
                public void onResourceReady(GlideDrawable glideDrawable, GlideAnimation<? super GlideDrawable> glideAnimation) {
                    iMVViewHolder.mImage.setImageDrawable(glideDrawable);
                }
            });
...
//                    }
//                });
            Glide.with(mContext).load(R.mipmap.aliyun_svideo_more).into(new SimpleTarget<GlideDrawable>() {
                @Override
                public void onResourceReady(GlideDrawable glideDrawable, GlideAnimation<? super GlideDrawable> glideAnimation) {
                    iMVViewHolder.mImage.setImageDrawable(glideDrawable);
                }
...
//                    }
//                });
            Glide.with(mContext).load(imvForm.getIcon()).into(new SimpleTarget<GlideDrawable>() {
                @Override
                public void onResourceReady(GlideDrawable glideDrawable, GlideAnimation<? super GlideDrawable> glideAnimation) {
                    iMVViewHolder.mImage.setImageDrawable(glideDrawable);
                }
