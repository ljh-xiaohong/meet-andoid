...
public class ApiImp {
     ...
     * 首页推荐用户视频数据队列api
     */
    public void findSlideIds(Map<String, Object> paramMap, Object paramObject, DataIdCallback<String> callback) {
        this.mHttpRequst.postRequst(UrlConstant.FINDSLIDEIDS, paramMap, paramObject, callback);
    }
