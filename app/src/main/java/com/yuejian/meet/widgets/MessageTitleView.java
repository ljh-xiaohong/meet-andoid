...
public class MessageTitleView extends LinearLayout {
    ...
    public MessageTitleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MessageTitleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.message_title, this, true);
