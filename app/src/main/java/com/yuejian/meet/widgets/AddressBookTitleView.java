 ...
 * @desc : 搜索- 顶部标题栏
 */
public class AddressBookTitleView extends LinearLayout {
    ...
    public AddressBookTitleView(Context context) {
        this(context, null);
    }

    public AddressBookTitleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AddressBookTitleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.address_book_title_view, this, true);
