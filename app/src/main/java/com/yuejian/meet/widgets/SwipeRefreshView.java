...
public class SwipeRefreshView extends SwipeRefreshLayout {
    ...
    private boolean canLoadMore() {
        ...
        if (mListView.getFirstVisiblePosition() == 0) {
            Bus.getDefault().post(new BusCallEntity(null, false, "list_to_top", null));
        } else {
            Bus.getDefault().post(new BusCallEntity(null, false, "list_scrolling", null));
        }
...
//                }
//            }
            if (mItemCount > mListView.getAdapter().getCount()) {
                condition2 = false;
            } else {
