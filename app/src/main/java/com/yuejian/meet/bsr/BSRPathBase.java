...
public class BSRPathBase {
    protected List<PointF> positionControlPoint;//位置控制
    protected List<Float> scaleControl;//缩放控制
    protected List<Float> rotationControl;//旋转控制
