...
public class HomeActionAdapter extends FKAdapter<ActionEntity> {
    ...
    public HomeActionAdapter(AbsListView view, List<ActionEntity> mDatas, int itemLayoutId, Activity activity) {
        ...
        if (actionPhoto.size() == 1) {
            ...
            mHelper.setClickListener(R.id.img_action_one_img, new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (StringUtils.isNotEmpty(item.url_type) && "2".equals(item.url_type)) {
                        ...
                        list.add(url_img);
                        Utils.displayImages(context, list, 0, null);
                    }
                }
            });
            ...
            innerGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Utils.displayImages(context, list, position, null);
                }
            });
