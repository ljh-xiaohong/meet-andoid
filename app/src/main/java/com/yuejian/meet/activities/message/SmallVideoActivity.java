 ...
 */
public class SmallVideoActivity extends UI implements SurfaceHolder.Callback {

    private static final String TAG = "video";

    private static final String EXTRA_DATA_FILE_NAME = "EXTRA_DATA_FILE_NAME";

    private static final int VIDEO_TIMES = 8;
    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            recordingTimeTextView.setText(TimeUtil.secToTime(8-invs));
