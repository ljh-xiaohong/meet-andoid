 ...
 * 自主创群 群公告
 */
public class GroupsNoticeActivity extends BaseActivity {
...
//            notice_cotent.setEnabled(false);
    ...
    public void postData(){
        ...
        params.put("content",notice_cotent.getText().toString());
        api.getGroupNotece(params, this, new DataIdCallback<String>() {
            @Override
