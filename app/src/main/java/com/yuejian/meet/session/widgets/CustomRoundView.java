...
public class CustomRoundView extends ImageView {
	...
	public CustomRoundView(Context context, AttributeSet attrs, int defStyle) {
		...
		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.CustomRoundView_crv_border_width, DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.CustomRoundView_crv_border_color,
	...
	private void setup() {
		...
		mBitmapShader = new BitmapShader(mBitmap, Shader.TileMode.CLAMP,
				Shader.TileMode.CLAMP);//CLAMP  如果渲染器超出原始边界范围，会复制范围内边缘染色
