...
public class AVChatSurface {
    ...
    public void initLargeSurfaceView(String account) {
        ...
        if (DemoCache.getAccount().equals(account)) {
            AVChatManager.getInstance().setupLocalVideoRender(largeRender, false, AVChatVideoScalingType.SCALE_ASPECT_FILL);
        } else {
            AVChatManager.getInstance().setupRemoteVideoRender(account, largeRender, false, AVChatVideoScalingType.SCALE_ASPECT_FILL);
        }
...
//                largeRender.getHolder().getSurface().release();
