...
public class FolderTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    // 默认展开文字
    private static final String DEFAULT_UNFOLD_TEXT = "  更多";
    // 默认固定行数
    private static final int DEFAULT_FOLD_LINE = 2;
    // 默认收起和展开文字颜色
    private static final int DEFAULT_TAIL_TEXT_COLOR = 0xFF999999;
    // 默认收起和展开文字颜色
    private static final int DEFAULT_TAIL_TEXT_SIZE = 39;
    // 默认是否可以再次收起
    ...
    public FolderTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTailSize = a.getDimension(R.styleable.FolderTextView_tailTextSize, DEFAULT_TAIL_TEXT_SIZE);
     ...
     * 设置尾部文字大小
     *
     * @param mTailSize 尾部文字大小
     */
    public void setTailSize(int mTailSize) {
        mTailSize = mTailSize;
        invalidate();
    }
